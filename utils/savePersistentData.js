//Generacion de matrices de ADN con n de 8,100,1000 y 3000
...
fs.mkdir(route, { recursive: true }, (err) => {
    ...
    fs.writeFileSync(`${route}/data3000.data`, data3000.join('\n'));
    ...
    fs.writeFileSync(`${route}/data3000.json`, JSON.stringify({"dna":data3000}));
